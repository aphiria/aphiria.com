...
exports.extractLexemes = extractLexemes;
 ...
 */
function extractLexemes(html, version, slug) {
 ...
 */
function processNode(node, lexemes, version, slug, state, ElementClass) {
 ...
 */
function shouldSkipNode(node, ElementClass) {
    if (!(node instanceof ElementClass)) {
        return false;
    }
 ...
 */
function createLexemeRecord(element, version, slug, state) {
 ...
 */
function buildLink(element, version, slug, state) {
...
//# sourceMappingURL=lexeme-extractor.js.map