...
Before you attempt to write a bug fix, first read the documentation to see if you're perhaps using Aphiria incorrectly.  If you find a hole in our documentation, feel free to open a <a href="https://github.com/aphiria/aphiria.com" target="_blank">pull request</a> to fix it.
...
You can find all the documentation for Aphiria <a href="https://github.com/aphiria/aphiria.com/tree/master/docs" target="_blank">here</a>.  To improve our documentation, please feel free to submit a pull request.  A few things on style:
